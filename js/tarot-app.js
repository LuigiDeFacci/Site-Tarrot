        ...
        const cards = [
            ...
            { name: "A Justiça", image: "/images/cartas/ajustica.png", meaning: "Justiça, verdade, causa e efeito, lei, clareza, responsabilidade, equilíbrio.", reversedMeaning: "Injustiça, desonestidade, falta de responsabilidade, parcialidade, emaranhados legais, desequilíbrio." }, // Assumes filename 'ajustica.png'
            ...
            { name: "A Força", image: "/images/cartas/aforca.png", meaning: "Coragem, compaixão, força interior, paciência, influência, controle, domar a fera.", reversedMeaning: "Fraqueza, insegurança, falta de disciplina, emoção crua, vulnerabilidade, ceder." }, // Assumes filename 'aforca.png'
            ...
            { name: "A Temperança", image: "/images/cartas/atemperanca.png", meaning: "Equilíbrio, moderação, paciência, harmonia, propósito, integração, mistura de opostos.", reversedMeaning: "Desequilíbrio, excesso, falta de paciência, discórdia, extremos, conflito." }, // Assumes filename 'atemperanca.png'
