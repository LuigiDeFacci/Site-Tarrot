        ...
        const cards = [
                         { name: "O Louco", image: "/images/cartas/olouco.jpg", meaning: "Novos começos, inocência, espontaneidade, fé, potencial, o salto de fé.", reversedMeaning: "Imprudência, medo do desconhecido, contenção, ingenuidade, tolice, distração." },
            { name: "O Mago", image: "/images/cartas/omago.jpg", meaning: "Manifestação, força de vontade, desenvoltura, habilidade, ação, concentração.", reversedMeaning: "Manipulação, mau planejamento, talentos inexplorados, engano, ilusão, truques." },
            { name: "A Sacerdotisa", image: "/images/cartas/asacerdotisa.jpg", meaning: "Intuição, subconsciente, mistério, segredos, voz interior, sabedoria, paciência.", reversedMeaning: "Segredos revelados, ignorar a intuição, confusão, sentimentos reprimidos, agendas ocultas." }, // Name Updated
            { name: "A Imperatriz", image: "/images/cartas/aimperatriz.jpg", meaning: "Nutrição, fertilidade, abundância, natureza, beleza, criatividade, sensualidade.", reversedMeaning: "Bloqueio criativo, dependência, sufocamento, estagnação, negligência, insegurança." },
            { name: "O Imperador", image: "/images/cartas/oimperador.jpg", meaning: "Autoridade, estrutura, controle, estabilidade, liderança, proteção, figura paterna.", reversedMeaning: "Tirania, rigidez, dominação, falta de disciplina, abuso de poder, teimosia." },
            { name: "O Hierofante", image: "/images/cartas/ohierofante.jpg", meaning: "Tradição, instituições, conformidade, moralidade, orientação espiritual, educação.", reversedMeaning: "Rebelião, desafiar normas, não convencionalidade, novos paradigmas, liberdade." }, // Name Updated
            { name: "Os Amantes", image: "/images/cartas/osamantes.jpg", meaning: "Amor, harmonia, relacionamentos, escolhas, alinhamento, união, valores.", reversedMeaning: "Desarmonia, desequilíbrio, conflito, más escolhas, desalinhamento, indecisão." }, // Name Updated
            { name: "O Carro", image: "/images/cartas/ocarro.jpg", meaning: "Força de vontade, controle, vitória, determinação, ambição, direção, foco.", reversedMeaning: "Falta de controle, oposição, sem direção, agressão, desistência, energia dispersa." },
            { name: "Justiça", image: "/images/cartas/justica.jpg", meaning: "Justiça, verdade, causa e efeito, lei, clareza, responsabilidade, equilíbrio.", reversedMeaning: "Injustiça, desonestidade, falta de responsabilidade, parcialidade, emaranhados legais, desequilíbrio." }, // Name Updated, accent removed in filename
            { name: "O Eremita", image: "/images/cartas/oeremita.jpg", meaning: "Introspecção, solidão, orientação, sabedoria, busca da alma, retirada para insight.", reversedMeaning: "Isolamento, solidão, retraimento, paranoia, tornar-se antissocial, rejeição." },
            { name: "A Roda da Fortuna", image: "/images/cartas/arodadafortuna.jpg", meaning: "Destino, ciclos, sorte, mudança, pontos de virada, destino, carma.", reversedMeaning: "Má sorte, resistência à mudança, quebra de ciclos, infortúnio, contratempos imprevistos." },
            { name: "A Força", image: "/images/cartas/aforca.jpg", meaning: "Coragem, compaixão, força interior, paciência, influência, controle, domar a fera.", reversedMeaning: "Fraqueza, insegurança, falta de disciplina, emoção crua, vulnerabilidade, ceder." }, // Name Updated, accent removed in filename
            { name: "O Enforcado", image: "/images/cartas/oenforcado.jpg", meaning: "Rendição, nova perspectiva, pausa, sacrifício, deixar ir, sabedoria adquirida.", reversedMeaning: "Adiamento, resistência, martírio, indecisão, sacrifício desnecessário, evitação." },
            { name: "A Morte", image: "/images/cartas/amorte.jpg", meaning: "Finais, transformação, mudança profunda, liberação, transição, novos começos.", reversedMeaning: "Resistência à mudança, medo de finais, estagnação, apego, repetição de padrões." },
            { name: "A Temperança", image: "/images/cartas/atemperanca.jpg", meaning: "Equilíbrio, moderação, paciência, harmonia, propósito, integração, mistura de opostos.", reversedMeaning: "Desequilíbrio, excesso, falta de paciência, discórdia, extremos, conflito." }, // Accent removed in filename
            { name: "O Diabo", image: "/images/cartas/odiabo.jpg", meaning: "Escravidão, vício, materialismo, restrição, sombra, tentação, padrões negativos.", reversedMeaning: "Libertação, desapego, liberação, enfrentar medos, empoderamento, retomar o controle." },
            { name: "A Torre", image: "/images/cartas/atorre.jpg", meaning: "Mudança súbita, reviravolta, revelação, destruição de falsas estruturas, caos, despertar.", reversedMeaning: "Evitar desastre, medo da mudança, resistir à destruição, evitar crise, caos interno." },
            { name: "A Estrela", image: "/images/cartas/aestrela.jpg", meaning: "Esperança, fé, inspiração, renovação, espiritualidade, serenidade, cura.", reversedMeaning: "Desespero, falta de fé, desânimo, desconexão, desesperança, negatividade." },
            { name: "A Lua", image: "/images/cartas/alua.jpg", meaning: "Intuição, ilusão, medo, subconsciente, incerteza, sonhos, coisas ocultas.", reversedMeaning: "Libertar o medo, clareza, compreensão, desvendar segredos, diminuir a confusão." },
            { name: "O Sol", image: "/images/cartas/osol.jpg", meaning: "Alegria, sucesso, positividade, vitalidade, calor, clareza, otimismo, iluminação.", reversedMeaning: "Falta de sucesso, pessimismo, tristeza, falta de clareza, felicidade bloqueada, ego." },
            { name: "O Julgamento", image: "/images/cartas/ojulgamento.jpg", meaning: "Renascimento, despertar, acerto de contas, avaliação, absolvição, chamado, perdão.", reversedMeaning: "Insegurança, ignorar o chamado, medo do julgamento, indecisão, autocrítica severa." },
            { name: "O Mundo", image: "/images/cartas/omundo.jpg", meaning: "Conclusão, integração, realização, viagem, cumprimento, totalidade, sucesso.", reversedMeaning: "Incompletude, falta de encerramento, estagnação, atrasos, vazio, sentir-se preso." },// WANDS (Paus - pt-BR Meanings)
             // PAUS (Paus - pt-BR Meanings)
